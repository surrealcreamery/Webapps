 ...
 */
export interface AchBankAccountDetails {
    /**
 ...
 *
 * The ACH tokenization flow supports a number of different
...
export interface AchDetails {
    /**
     * The ACH auth tokenization flow that was run.
     */
    intent?: string;
}
 ...
 */
export declare enum PlaidEventName {
