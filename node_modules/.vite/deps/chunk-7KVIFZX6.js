...
var Tooltip = React4.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React4.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime3.jsx)("span", {
    children: childrenProp
  });
  ...
  return (0, import_jsx_runtime3.jsxs)(React4.Fragment, {
    children: [React4.cloneElement(children, childrenProps), (0, import_jsx_runtime3.jsx)(PopperSlot, {
...
var Toolbar = React5.forwardRef(function Toolbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(ToolbarRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
...
var TablePaginationActions = React6.forwardRef(function TablePaginationActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTablePaginationActions"
  });
...
//# sourceMappingURL=chunk-7KVIFZX6.js.map
