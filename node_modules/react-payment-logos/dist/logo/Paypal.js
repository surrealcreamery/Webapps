...
var SvgPaypal = function (props) { return (React.createElement("svg", tslib_1.__assign({ xmlns: "http://www.w3.org/2000/svg", xmlSpace: "preserve", width: 48, height: 48, viewBox: "0 0 780 500" }, props),
    ...
    React.createElement("path", { fill: "#009CDE", d: "M720.79 160.68h-24.207c-2.406 0-3.822 1.2-4.254 3.601l-21.266 136.1-.328.654c0 1.096.436 2.127 1.311 3.109.867.98 1.963 1.471 3.27 1.471h21.596c4.137 0 6.428-2.068 6.871-6.215l21.264-133.81v-.325c-.001-3.055-1.423-4.581-4.257-4.581z" }),
